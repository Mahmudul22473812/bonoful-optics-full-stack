...
-- CreateEnum
CREATE TYPE "MovementType" AS ENUM ('OPENING', 'RECEIPT', 'ADJUSTMENT', 'DAMAGE', 'LOSS', 'RESERVATION', 'RELEASE', 'SHIPMENT', 'RETURN');
...
CREATE TABLE "Product" (
    ...
    "prescriptionAllowed" BOOLEAN NOT NULL DEFAULT true,
    "active" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE "SupplierProduct" (
    ...
    CONSTRAINT "SupplierProduct_pkey" PRIMARY KEY ("supplierId","variantId")
);
...
-- CreateIndex
CREATE INDEX "Product_active_archivedAt_createdAt_idx" ON "Product"("active", "archivedAt", "createdAt");

-- CreateIndex
CREATE INDEX "Product_categoryId_brandId_idx" ON "Product"("categoryId", "brandId");

-- CreateIndex
CREATE INDEX "Product_gender_shape_idx" ON "Product"("gender", "shape");
...
-- CreateIndex
CREATE UNIQUE INDEX "Prescription_fileId_key" ON "Prescription"("fileId");
...
-- CreateIndex
CREATE INDEX "Outbox_status_nextAttempt_idx" ON "Outbox"("status", "nextAttempt");
...
-- AddForeignKey
ALTER TABLE "SupplierProduct" ADD CONSTRAINT "SupplierProduct_variantId_fkey" FOREIGN KEY ("variantId") REFERENCES "ProductVariant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Prescription" ADD CONSTRAINT "Prescription_fileId_fkey" FOREIGN KEY ("fileId") REFERENCES "File"("id") ON DELETE SET NULL ON UPDATE CASCADE;
